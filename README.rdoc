...
Fire it up with a mighty

    j

Boom.

Oh yeah. That's the stuff. You should have Vim open to today's post.
Go ahead and write yourself some sweet, sweet entries.

Once you've finished that madness, save it with a rad
...
and check out your awesome post.
